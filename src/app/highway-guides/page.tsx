...
export const metadata: Metadata = {
  title: '2026 DOT Regulations & Highway Travel Guides | TRUCK & MUSCLE',
  description: 'FMCSA electronic logging rules, hours of service, weigh station overweight fines, bridge formula limits, and top Interstate truck stops.',
};

export default function HighwayGuidesPage() {
  const articles = ARTICLES.filter((a) => a.category === 'highway-guides');
    ...
    <div className="container-newsfolk" style={{ paddingTop: '24px' }}>
      <div style={{ marginBottom: '32px', textAlign: 'center' }}>
        <span className="newsfolk-badge badge-blue" style={{ marginBottom: '8px' }}>
          COMPLIANCE & TRAVEL SECTION
        </span>
        <h1 style={{ fontSize: '2.4rem', fontWeight: 900, color: 'var(--text-headline)', marginBottom: '8px' }}>
          DOT Regulations & Interstate Highway Guides
        </h1>
        <p style={{ color: 'var(--text-muted)', maxWidth: '650px', margin: '0 auto', fontSize: '1rem' }}>
          Essential compliance guides, electronic logging rules, bridge formulas, and verified travel plazas along I-40, I-80 and I-95.
        </p>
      </div>
