...
import { Clock, Share2, ShieldAlert } from 'lucide-react';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Big Rigs & Heavy Haul Semis | Peterbilt, Kenworth, Mack | TRUCK & MUSCLE',
  description: 'American class 8 semi trucks, Cummins X15 and Detroit DD15 power, custom sleepers, long-haul reviews and owner-operator stories.',
};

export default function BigRigsPage() {
  const articles = ARTICLES.filter((a) => a.category === 'big-rigs');
    ...
    <div className="container-newsfolk" style={{ paddingTop: '24px' }}>
      <div style={{ marginBottom: '32px', textAlign: 'center' }}>
        <span className="newsfolk-badge badge-red" style={{ marginBottom: '8px' }}>
          CLASS 8 HEAVY HAUL SECTION
        </span>
        <h1 style={{ fontSize: '2.4rem', fontWeight: 900, color: 'var(--text-headline)', marginBottom: '8px' }}>
          American Big Rigs & Heavy Haul Semis
        </h1>
        <p style={{ color: 'var(--text-muted)', maxWidth: '650px', margin: '0 auto', fontSize: '1rem' }}>
          In-depth reviews, dyno tests, sleeper comfort comparisons, and owner-operator insights on Peterbilt, Kenworth, Freightliner, and Mack.
        </p>
      </div>
